...
<body>
            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="CustomerID"  InsertItemPosition="LastItem"  OnItemUpdating="ListView1_ItemUpdating" OnItemEditing="ListView1_ItemEditing"
              OnItemCanceling="ListView1_ItemCanceling" OnSorting="ListView1_Sorting" OnItemInserting="ListView1_ItemInserting"
               OnItemDeleting="ListView1_ItemDeleting" >
                ...
                <LayoutTemplate>
                    <table runat="server"  class="table table-dark table-striped table-bordered table-hover">
                        <tr runat="server">
                            <td runat="server">
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item  <%=CurrentPage==1||CurrentPage==0?"disabled":"" %>">
      <a class="page-link bg-dark text-white" href="CrudSPPagingSortingBootstrap.aspx?currentPage=<%=CurrentPage-1 %>&sort=<%=pageSort %>" tabindex="-1">Previous</a>
    </li>

     <%for (int i = 1; i <= TotalPage; i++)
            {%>
 <li class="page-item  "><a class="page-link  <%=i==CurrentPage?"bg-ligth  text-success":"bg-dark text-white" %>" href="CrudSPPagingSortingBootstrap.aspx?currentPage=<%=i %>&sort=<%=pageSort %>"><%=i %></a></li>
            <%} %>
    <li class="page-item  <%=CurrentPage==TotalPage?"disabled":"" %>">
      <a class="page-link bg-dark text-white" href="CrudSPPagingSortingBootstrap.aspx?currentPage=<%=CurrentPage+1 %>&sort=<%=pageSort %> ">Next</a>
    </li>
  </ul>
