<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paginationOnSlide.aspx.cs" Inherits="MyWebFormCases.bootstrap.paginationOnSlide" %>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <%-- first  the second row e --%>



    </div>
    <div class="carousel-item">
      <%-- second  the first row --%>
        <div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
