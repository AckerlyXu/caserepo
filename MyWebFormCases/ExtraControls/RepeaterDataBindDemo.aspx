<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepeaterDataBindDemo.aspx.cs" Inherits="MyWebFormCases.ExtraControls.RepeaterDataBindDemo" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EntityExe %>" SelectCommand="SELECT [id], [Question], [Option1], [Option2], [Option3] FROM [Questions]" ></asp:SqlDataSource>
